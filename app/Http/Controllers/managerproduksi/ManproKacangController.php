...
class ManproKacangController extends Controller
{
    ...
    public function home()
    {
        ...
        $kacang_hc = Stock::select('stock.*')
                    ...
                    ->where(['detail_order_masak.id_bahan_product' => 'PR00000000001', 'stock.id_gudang' => '9', 'stock.id_bahan_baku' => 'BB000000010'])
                    ->sum('stock.stock');           

        $kacang_sp = Stock::select('stock.*')
                    ->join('order_masak','stock.id_transaksi' ,'=', 'order_masak.id_order_masak')
                    ->join('detail_order_masak', 'order_masak.id_order_masak', '=', 'detail_order_masak.id_order_masak')
                    ->where(['detail_order_masak.id_bahan_product' => 'PR00000000002', 'stock.id_gudang' => '9', 'stock.id_bahan_baku' => 'BB000000010'])
                    ->sum('stock.stock'); 

        $kacang_gs = Stock::select('stock.*')
                    ->join('order_masak','stock.id_transaksi' ,'=', 'order_masak.id_order_masak')
                    ->join('detail_order_masak', 'order_masak.id_order_masak', '=', 'detail_order_masak.id_order_masak')
                    ->where(['detail_order_masak.id_bahan_product' => 'PR00000000003', 'stock.id_gudang' => '9', 'stock.id_bahan_baku' => 'BB000000010'])
                    ->sum('stock.stock');    
        
        $kacang_telor = Stock::select('stock.*')
                    ->join('order_masak','stock.id_transaksi' ,'=', 'order_masak.id_order_masak')
                    ->join('detail_order_masak', 'order_masak.id_order_masak', '=', 'detail_order_masak.id_order_masak')
                    ->where(['detail_order_masak.id_bahan_product' => 'PR00000000004', 'stock.id_gudang' => '9', 'stock.id_bahan_baku' => 'BB000000010'])
                    ->sum('stock.stock');  
