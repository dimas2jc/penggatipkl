...
{{-- Judul --}}
@section('title', 'Manager Produksi | Data Produksi | Gudang Bumbu | Stock Adonan Gula')
...
{{-- Judul Halaman --}}
@section('page-title', 'Stock Adonan Gula')
...
<li class="breadcrumb-item active" aria-current="page">Stock Adonan Gula</li>
@endsection
        ...
        {{-- Start Adonan Gula --}}
         <div class="card m-b-30">
             <div class="card-header">
                <h5 class="card-title">Adonan Gula</h5>
             </div>
             <div class="card-body">
