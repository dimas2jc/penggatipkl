        ...
        <div class="navigationbar">
            <div class="vertical-menu-icon">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <div class="logobar">
                        <a href="{{url('/')}}" class="logo logo-small"><img src="{{asset('assets/images/logo_gangsar.png')}}" class="img-fluid" alt="logo"></a>
                    </div>
            ...
            <div class="vertical-menu-detail">
                <div class="logobar">
                    <a href="{{url('/')}}" class="logo logo-large"><img src="{{asset('assets/images/logo_gangsar.png')}}" class="img-fluid" alt="logo"></a>
                </div>
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-crm" role="tabpanel" aria-labelledby="v-pills-crm-tab">
                        <ul class="vertical-menu">
                            ...
                            <li><a href="{{url('/')}}"><img src="{{asset('assets/images/svg-icon/dashboard.svg')}}" class="img-fluid" alt="dashboard">Dashboard</a></li>
                            <li><a href="{{url('/crm-projects')}}"><img src="{{asset('assets/images/svg-icon/reports.svg')}}" class="img-fluid" alt="projects">Projects</a></li>
                            <li><a href="{{url('/crm-lead-status')}}"><img src="{{asset('assets/images/svg-icon/charts.svg')}}" class="img-fluid" alt="leads">Lead Status</a></li>
                            <li><a href="{{url('/crm-clients')}}"><img src="{{asset('assets/images/svg-icon/customers.svg')}}" class="img-fluid" alt="clients">Clients</a></li>
                        </ul>
                    </div>
                    <div class="tab-pane fade" id="v-pills-ecommerce" role="tabpanel" aria-labelledby="v-pills-ecommerce-tab">
                        <ul class="vertical-menu">
                            ...
                            <li><a href="{{url('/dashboard-ecommerce')}}"><img src="{{asset('assets/images/svg-icon/dashboard.svg')}}" class="img-fluid" alt="dashboard">Dashboard</a></li>
                            <li>
                    ...
                    <div class="tab-pane fade" id="v-pills-hospital" role="tabpanel" aria-labelledby="v-pills-hospital-tab">
                        <ul class="vertical-menu">
                            ...
                            <li><a href="{{url('/dashboard-hospital')}}"><img src="{{asset('assets/images/svg-icon/dashboard.svg')}}" class="img-fluid" alt="dashboard">Dashboard</a></li>
                            <li><a href="{{url('/hospital-appointment')}}"><img src="{{asset('assets/images/svg-icon/calender.svg')}}" class="img-fluid" alt="appointments">Appointments</a></li>
                            <li><a href="{{url('/hospital-doctor')}}"><img src="{{asset('assets/images/svg-icon/doctor.svg')}}" class="img-fluid" alt="doctors">Doctors</a></li>
                            <li><a href="{{url('/hospital-patient')}}"><img src="{{asset('assets/images/svg-icon/customers.svg')}}" class="img-fluid" alt="patients">Patients</a></li>
                        </ul>
                    </div>
